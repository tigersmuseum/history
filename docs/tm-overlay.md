...
This overlay was created using an XSLT transform. See the **map overlay** target in *[places/build.xml](https://github.com/tigersmuseum/history/blob/gh-pages/places/build.xml)* for the input data and stylesheet used. 
